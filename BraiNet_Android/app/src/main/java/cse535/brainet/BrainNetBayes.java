...
//    private Instances testingDataset;
    ...
    public BrainNetBayes(Context context) {
...
//                this.testingDataset = getDataSet(testingData);
    ...
    public BrainNetBayes(String path) {
        try {
            Classifier cls = null;
...
//                this.testingDataset = getDataSet(testingData);
    ...
    public static void mains(String[] args) {
        ...
        try {
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\ryane\\AndroidStudioProjects\\CSE535-BraiNetProject2\\BraiNet_Android\\app\\src\\main\\assets\\bayes.model"));
...
//            retVal = testingDataset.attribute(0).value((int) index);
    ...
    public static void main(String[] args) {
        BrainNetBayes brainNetBayes = new BrainNetBayes("C:\\Users\\ryane\\AndroidStudioProjects\\CSE535-BraiNetProject2\\BraiNet_Android\\app\\src\\main\\assets\\bayes.model");
...
//                brainNetBayes.printAccuracy(test, trainingDataSet);
    ...
    private class LoadDataSetTask extends AsyncTask<String, Integer, Instances> {
        ...
        protected void onPostExecute(Instances result) {
            ...
            try {
                filter.setInputFormat(dataSet);
                BrainNetBayes.this.dataSet = Filter.useFilter(dataSet, filter);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
