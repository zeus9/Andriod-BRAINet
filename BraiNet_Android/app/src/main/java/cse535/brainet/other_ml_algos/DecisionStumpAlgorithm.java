...
public class DecisionStumpAlgorithm {
    ...
    public DecisionStumpAlgorithm(Context context) {
...
//                this.testingDataset = getDataSet(testingData);
    ...
    public DecisionStumpAlgorithm(String path) {
        try {
            Classifier cls = null;
...
//                this.testingDataset = getDataSet(testingData);
    ...
    public static void mains(String[] args) {
        ...
        try {
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\ryane\\AndroidStudioProjects\\CSE535-BraiNetProject2\\BraiNet_Android\\app\\src\\main\\assets\\decision_stump.model"));
...
//            retVal = testingDataset.attribute(0).value((int) index);
    ...
    public static void main(String[] args) {
        DecisionStumpAlgorithm brainNetBayes = new DecisionStumpAlgorithm("C:\\Users\\ryane\\AndroidStudioProjects\\CSE535-BraiNetProject2\\BraiNet_Android\\app\\src\\main\\assets\\decision_stump.model");
...
//                brainNetBayes.printAccuracy(test, trainingDataSet);
    ...
    private class LoadDataSetTask extends AsyncTask<String, Integer, Instances> {
        ...
        protected void onPostExecute(Instances result) {
            ...
            try {
                filter.setInputFormat(dataSet);
                DecisionStumpAlgorithm.this.dataSet = Filter.useFilter(dataSet, filter);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
