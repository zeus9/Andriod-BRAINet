...
public class DecisionTableAlgorithm {
    ...
    public DecisionTableAlgorithm(Context context) {
...
//                this.testingDataset = getDataSet(testingData);
    ...
    public DecisionTableAlgorithm(String path) {
        try {
            Classifier cls = null;
...
//                this.testingDataset = getDataSet(testingData);
    ...
    public static void mains(String[] args) {
        ...
        try {
            ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\ryane\\AndroidStudioProjects\\CSE535-BraiNetProject2\\BraiNet_Android\\app\\src\\main\\assets\\decision_table.model"));
...
//            retVal = testingDataset.attribute(0).value((int) index);
    ...
    public static void main(String[] args) {
        DecisionTableAlgorithm brainNetBayes = new DecisionTableAlgorithm("C:\\Users\\ryane\\AndroidStudioProjects\\CSE535-BraiNetProject2\\BraiNet_Android\\app\\src\\main\\assets\\decision_table.model");
...
//        String train = "C:\\Users\\ryane\\AndroidStudioProjects\\CSE535-BraiNetProject2\\BraiNet_Android\\app\\src\\main\\assets\\train.csv";
//        try {
...
//                brainNetBayes.printAccuracy(test, trainingDataSet);
    ...
    private class LoadDataSetTask extends AsyncTask<String, Integer, Instances> {
        ...
        protected void onPostExecute(Instances result) {
            ...
            try {
                filter.setInputFormat(dataSet);
                DecisionTableAlgorithm.this.dataSet = Filter.useFilter(dataSet, filter);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
