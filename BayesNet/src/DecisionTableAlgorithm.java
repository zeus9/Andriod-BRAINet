...
public class DecisionTableAlgorithm {
    private static final String TRAINING_DATA_SET_FILENAME = "C:\\Users\\ryane\\Desktop\\Combined_Training_data.csv";
//    private static final String PREDICTION_DATA_SET_FILENAME = "C:\\Users\\ryane\\workspace\\BrainNetServer\\data\\nominal_S001R03.csv";
    ...
    public DecisionTableAlgorithm(String trainingFilePath) {
        try {
    ...
    public static void main(String[] args) {
        try {
            System.out.println(new DecisionTableAlgorithm(TRAINING_DATA_SET_FILENAME).tryEntry("C:\\Users\\ryane\\workspace\\BrainNetServer\\data\\nominal_S001R01.csv", 0));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
