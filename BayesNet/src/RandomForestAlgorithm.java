...
//    private static final String PREDICTION_DATA_SET_FILENAME = "C:\\Users\\ryane\\workspace\\BrainNetServer\\data\\nominal_S001R03.csv";
    ...
    public RandomForestAlgorithm(String trainingFilePath) {
        try {
    ...
    public static void main(String[] args) {
        try {
            System.out.println(new RandomForestAlgorithm(TRAINING_DATA_SET_FILENAME).tryEntry("C:\\Users\\ryane\\workspace\\BrainNetServer\\data\\nominal_S001R01.csv", 0));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
