...
public class Server implements Runnable{
    ...
    private static String testingDatasetFilename;
        ...
        * */
        ...
        try {
            if (args.length == 1) {
                 ...
                 * */
                testingDatasetFilename = args[0];
            } else {
                System.out.println("Server must be started with 1 argument: [path_to_training_data]");
                System.exit(0);
            }

            System.out.println("Creating model...");
            brainNetBayes = new BrainNetBayes(testingDatasetFilename);
        ...
        try {
            ...
            if (method.equals("POST")) {
                ...
                while ((line = in.readLine()) != null) {
                    if (line.equals("done")) {
                        int indexOfEntry = Integer.parseInt(previousLine);
                        response = brainNetBayes.tryEntry(indexOfEntry);
                        break;
                    } else {
                        previousLine = line;
                    }
